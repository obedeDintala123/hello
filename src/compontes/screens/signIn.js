...
const SignIn = () => {
    return (
            ...
            <form className='lg:w-3/12 flex flex-col gap-6 justify-between p-3 border shadow absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-sm:w-11/12 sm:w-11/12 md:w-3/5'>
          ...
          <Input type="email" placeholder="Número de Telefone ou E-mail" name="email" id="email"/>
           <Input type="password" placeholder="Senha" name="senha" id="senha" />
            ...
            <p className='text-sm'>Don't have an account? <a href="/signup" className='underline font-medium'>Sign Up</a></p>
        </form>
